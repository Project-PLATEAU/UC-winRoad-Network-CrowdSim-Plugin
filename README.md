...
本システムの詳細については技術検証レポートを参照してください(**技術検証レポート公開後、リンクを追記します**)。
...
### ①CityGML読込機能
- CityGMLを読み込みます。
- [3D都市モデル標準製品仕様書](https://www.mlit.go.jp/plateaudocument/#toc0_02)に準拠するCityGMLを読み込んだ場合、②による歩行エリア生成時にCityGMLの属性情報に基づいた歩行エリアが生成されます。第4.1版で動作することを確認しています。
...
- 技術検証レポート: **技術検証レポート公開後、リンクを追記します**
